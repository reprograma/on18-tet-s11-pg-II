...
//     const alunasEncontradas = alunas.find(alunaAtual => alunaAtual.turma == turma)
//     console.log(alunasEncontradas)
//     const notas = alunasEncontradas.notas

//     const {
//       ciencias_da_natureza, ciencias_humanas, linguagens_codigos, matematica, redacao } = notas

//     let notasAlunas = Object.values(alunasEncontradas.notas)
//     let media = (notasAlunas.reduce((acumulador, nota) => acumulador + nota)) / 5
...
//       situacao: situacao,
//       media: media,
//       nome: alunasEncontradas.nome_social || alunaEncontrada.nome_registro,
//       turma: alunasEncontradas.turma
//     }
//     res.status(200).send(resposta)
